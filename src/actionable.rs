//! Domain-specific validation for agent instruction files.
//!
//! Contains checks for actionable content and project structure paths.
//! Moved from `instruction-files::audit` to centralise rule validation.

use agent_kit::audit_common::{AuditConfig, Issue, is_agent_file};
